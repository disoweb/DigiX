      ...
      <div className="w-full max-w-md">
        <Card className="border-digix-blue-100">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-digix-blue-900 text-2xl">Purchase Successful!</CardTitle>
            <CardDescription>Your USDT has been purchased successfully</CardDescription>
          </CardHeader>
            ...
            <div className="border border-digix-blue-200 rounded-lg p-4">
              ...
              {walletOption === "digix" ? (
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">Your USDT has been credited to your DigiX wallet.</p>
                  <div className="bg-digix-blue-50 p-3 rounded-md">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">Previous balance:</span>
                      <span className="text-digix-blue-900">1,250.00 USDT</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">New balance:</span>
                      <span className="text-digix-blue-900 font-medium">{(1250 + Number(amount)).toFixed(2)} USDT</span>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">Your USDT has been sent to your external wallet:</p>
                  <div className="bg-digix-blue-50 p-3 rounded-md">
